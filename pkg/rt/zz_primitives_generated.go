...
func RegisterGeneratedPrimitives() {
	...
	if ns := LookupOrRegisterNSNoLoad("clojure.core"); ns != nil {
		...
		fn127, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNsInterns(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ns-interns", fn127)
		fn128, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNsRefers(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ns-refers", fn128)
		fn129, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNsMap(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ns-map", fn129)
		fn130, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNsAliases(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ns-aliases", fn130)
		fn131, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNsUnmap(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ns-unmap", fn131)
		fn132, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRemoveNs(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "remove-ns", fn132)
		fn133, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreFindVar(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "find-var", fn133)
		fn134, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreGetMethod(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "get-method", fn134)
		fn135, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreEnumerationSeq(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "enumeration-seq", fn135)
		fn136, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreLazySeq(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "lazy-seq*", fn136)
		fn137, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreWithMeta(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "with-meta", fn137)
		fn138, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreThrowf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "throw", fn138)
		fn139, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreExInfo(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ex-info", fn139)
		fn140, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreExMessage(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ex-message", fn140)
		fn141, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreExData(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ex-data", fn141)
		fn142, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreExCause(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ex-cause", fn142)
		fn143, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreDelayStar(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "delay*", fn143)
		fn144, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreForce(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "force", fn144)
		fn145, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsDelay(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "delay?", fn145)
		fn146, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsRealized(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "realized?", fn146)
		fn147, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreVolatilef(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "volatile!", fn147)
		fn148, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreVreset(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "vreset!", fn148)
		fn149, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreReducedf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "reduced", fn149)
		fn150, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsReducedf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "reduced?", fn150)
		fn151, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitAnd(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-and", fn151)
		fn152, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitOr(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-or", fn152)
		fn153, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitXor(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-xor", fn153)
		fn154, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitNot(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-not", fn154)
		fn155, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitShiftLeft(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-shift-left", fn155)
		fn156, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitShiftRight(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-shift-right", fn156)
		fn157, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreUnsignedBitShiftRight(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "unsigned-bit-shift-right", fn157)
		fn158, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitTest(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-test", fn158)
		fn159, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitSet(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-set", fn159)
		fn160, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitClear(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-clear", fn160)
		fn161, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitAndNot(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-and-not", fn161)
		fn162, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBitFlip(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bit-flip", fn162)
		fn163, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreReGroups(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "re-groups", fn163)
		fn164, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CorePromisef(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "promise", fn164)
		fn165, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreDeliver(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "deliver", fn165)
		fn166, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAddTap(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "add-tap", fn166)
		fn167, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRemoveTap(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "remove-tap", fn167)
		fn168, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreTapBang(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "tap>", fn168)
		fn169, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAddWatch(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "add-watch", fn169)
		fn170, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRemoveWatch(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "remove-watch", fn170)
		fn171, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreGetValidator(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "get-validator", fn171)
		fn172, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreSubvecf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "subvec", fn172)
		fn173, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsDouble(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "double?", fn173)
		fn174, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreInstancep(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "instance?", fn174)
		fn175, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsIFn(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ifn?", fn175)
		fn176, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIdentical(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "identical?", fn176)
		fn177, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAnyp(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "any?", fn177)
		fn178, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreUnreduced(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "unreduced", fn178)
		fn179, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreEnsureReduced(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ensure-reduced", fn179)
		fn180, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBigintf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bigint", fn180)
		fn181, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsRatio(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "ratio?", fn181)
		fn182, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsDecimal(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "decimal?", fn182)
		fn183, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsSorted(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "sorted?", fn183)
		fn184, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsMap(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "map?", fn184)
		fn185, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsSet(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "set?", fn185)
		fn186, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsMapEntry(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "map-entry?", fn186)
		fn187, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsLazySeq(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "lazy-seq?", fn187)
		fn188, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsReversible(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "reversible?", fn188)
		fn189, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRseqf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "rseq", fn189)
		fn190, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNumeratorf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "numerator", fn190)
		fn191, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreDenominatorf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "denominator", fn191)
		fn192, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBigdecf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bigdec", fn192)
		fn193, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRoundBigdec(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "round-bigdec", fn193)
		fn194, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRationalizef(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "rationalize", fn194)
		fn195, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreQuotf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "quot", fn195)
		fn196, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreRemf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "rem", fn196)
		fn197, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreHashf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "hash", fn197)
		fn198, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreParseDouble(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "parse-double", fn198)
		fn199, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreParseBool(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "parse-boolean", fn199)
		fn200, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsNaN(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "NaN?", fn200)
		fn201, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsInfinite(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "infinite?", fn201)
		fn202, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsBool(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "boolean?", fn202)
		fn203, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsChar(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "char?", fn203)
		fn204, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsVar(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "var?", fn204)
		fn205, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreByteArrayf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "byte-array", fn205)
		fn206, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreObjectArrayf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "object-array", fn206)
		fn207, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreMakeArrayf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "make-array", fn207)
		fn208, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAgetf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "aget", fn208)
		fn209, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAsetf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "aset", fn209)
		fn210, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAlengthf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "alength", fn210)
		fn211, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreAclonef(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "aclone", fn211)
		fn212, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBytesf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bytes", fn212)
		fn213, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreDoublesf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "doubles", fn213)
		fn214, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBytesP(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bytes?", fn214)
		fn215, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreVarGet(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "var-get", fn215)
		fn216, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreBoundQ(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "bound?", fn216)
		fn217, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreCopyFormSource(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "-copy-form-source!", fn217)
		fn218, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreChunkToFnFn(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "chunk->fn", fn218)
		fn219, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreMakeMultiArityFn(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "make-multi-arity", fn219)
		fn220, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreInternf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "intern", fn220)
		fn221, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreApplyDefMetaf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "apply-def-meta!", fn221)
		fn222, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreCreateNsf(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "create-ns", fn222)
		fn223, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CorePopBang(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "pop!", fn223)
		fn224, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsUUID(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "uuid?", fn224)
		fn225, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreIsInst(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "inst?", fn225)
		fn226, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreParseUUID(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "parse-uuid", fn226)
		fn227, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_CoreNumericEq(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "==", fn227)
		fn228, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Name(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "name", fn228)
		fn229, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Subs(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "subs", fn229)
		fn230, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Nth(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "nth", fn230)
		fn231, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Deref(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "deref", fn231)
		fn232, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Str(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "str", fn232)
		fn233, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Get(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "get", fn233)
		fn234, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Conj(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "conj", fn234)
		defGeneratedPrimitive(ns, "clojure.core", "reduce", vm.NewCtxNativeFn("reduce", _adapt_Reduce))
		fn236, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Namespace(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "namespace", fn236)
		...
		fn240, _ := vm.NativeFnType.Wrap(func(vs []vm.Value) (vm.Value, error) { return _adapt_Int(vs) })
		defGeneratedPrimitive(ns, "clojure.core", "int", fn240)
	}
	RegisterNativeModule(&NativeModule{
		GoPkg:     "github.com/nooga/let-go/pkg/rt",
