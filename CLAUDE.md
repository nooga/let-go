...
See [docs/clojure-test-suite.md](docs/clojure-test-suite.md) for the full workflow guide on running and improving coverage against the [jank-lang/clojure-test-suite](https://github.com/jank-lang/clojure-test-suite) (git submodule at `test/clojure-test-suite/`).

```bash
go test ./test/ -count=1 -run TestClojureTestSuite -v  # run the suite
```
