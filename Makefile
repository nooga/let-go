...
# lowered tree compiles and dispatches natively. The state-management and gate
# logic live in scripts/check-generated.sh; keep this target as the stable CI
# and contributor entry point.
check-generated: $(GO)
